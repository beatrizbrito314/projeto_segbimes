...
<div>
 ...
 <div class="banner" data-aos="fade-up" data-aos-duration="1500">
  ...
  text-align: center;">Métodos de Pagamento</h3>
       <input type = "radio" name = "metpag" value = "deb-avista"> <h4 style="color: white;
  text-shadow: 1px 1px 1px black;
  font-size: large;
  text-align: left;">Débito à Vista</h4>
        
        <h5 style="color: white;
  text-shadow: 1px 1px 1px black;
  font-size: large;
  text-align: left;">
        <input type = "text" placeholder="Número do Cartão" name = "numcartao-avista"></h5>
    
        
        <input type = "radio" name = "metpag" value = "credito"> <h4 style="color: white;
  text-shadow: 1px 1px 1px black;
  font-size: large;
  text-align: left;">Crédito à Vista</h4>
        <h5 style="color: white;
  text-shadow: 1px 1px 1px black;
  font-size: medium;
  text-align: left;"><input type = "text" placeholder=" Número do Cartão" name = "numcartao-credito"></h5>
    
    
    <input type = "radio" name = "metpag" value = "pix"><h4 style="color: white;
  text-shadow: 1px 1px 1px black;
  font-size: large;
  text-align: left;"> PIX (Chave Pix) </h4>
       <h5 style="color: white;
  text-shadow: 1px 1px 1px black;
  font-size: large;
  text-align: left;"><input type = "text" placeholder=" nomedaloja@gmail.com" name = "" readonly></h5>
